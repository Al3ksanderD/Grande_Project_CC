...
import com.codecool.el_projecto_grande.user.models.AppUserRole;
import com.codecool.el_projecto_grande.user.services.AppUserService;
import com.codecool.el_projecto_grande.email.EmailSender;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
        ...
        if(!isValidEmail){
            throw new IllegalStateException("email adres" + request.getEmail() + "is not valid");
        }
